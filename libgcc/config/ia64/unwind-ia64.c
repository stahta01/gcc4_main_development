...
#ifdef __hpux__
  /* On HPUX, the structure ucontext_t is opaque.  To comply with the ABI
     (which provides only the values, not their address), we copy them to
     this buffer, and use the address.  */
  struct
  {
    unw_word bsp;
    unw_word bspstore;
