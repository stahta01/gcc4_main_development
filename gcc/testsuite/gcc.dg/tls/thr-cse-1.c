...
/* { dg-final { scan-assembler-not "emutls_get_address.*emutls_get_address.*" { target { ! { "*-wrs-vxworks"  "*-*-darwin8"  "hppa*-*-hpux*" "spu-*-*" "i?86-*-mingw*" "x86_64-*-mingw*" lmp-*-* } } } } } */
...
/* { dg-final { scan-assembler-not "%l __emutls_get_address.*%l __emutls_get_address" { target lmp-*-* } } } */
