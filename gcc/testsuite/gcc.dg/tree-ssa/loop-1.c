...
/* The SH targets always use separate instructions to load the address
   ...
   relaxation.  */
/* CRIS and LMP keep the address in a register.  */
/* m68k sometimes puts the address in a register, depending on CPU and PIC.  */

/* { dg-final { scan-assembler-times "foo" 5 { xfail hppa*-*-* ia64*-*-* sh*-*-* cris-*-* crisv32-*-* fido-*-* m68k-*-* i?86-*-mingw* i?86-*-cygwin* x86_64-*-mingw* lmp-*-* } } } */
...
/* { dg-final { scan-assembler-times "bra *tr,r\[1-9\]*,r21" 5 { target lmp-*-* } } } */
