...
/* The block starting the second conditional has  3 incoming edges,
   ...
   zero.  */
/* { dg-final { scan-tree-dump-times "Threaded" 3 "dom1" { target { ! "lmp-*-* mips*-*-*" } } } } */
/* LMP and MIPS define LOGICAL_OP_NON_SHORT_CIRCUIT to 0, so we split var1 ||
   var2 into two conditions, rather than use (var1 != 0) | (var2 != 0).  */
/* { dg-final { scan-tree-dump-times "Threaded" 4 "dom1" { target { lmp-*-* mips*-*-* } } } } */
