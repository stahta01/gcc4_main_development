...
--  Version of System.OS_Interface for LynxOS 5 and LynxOS-178 (POSIX Threads)
...
package body System.OS_Interface is
   ...
   function sysconf (name : int) return size_t;
   function sysconf (name : int) return Address;
