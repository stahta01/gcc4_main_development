...
package body Ada.Exceptions is
   ...
   --  Call_Chain at exception raise points from this unit. The purpose is to
   --  arrange for the exception tracebacks not to include frames from routines
   --  involved in the raise process, as these are meaningless from the user's
   --  standpoint.
   --
   ...
   --
   --  1) The bodies of the subprograms involved in processing a raise are
   --     located after the body of Code_Address_For_AAA and before the
   --     body of Code_Address_For_ZZZ.
   --
   --  2) No pragma Inline applies to any of these subprograms, as this could
   --     delay the corresponding assembly output until the end of the unit.
   ...
   begin
      ...
      --  least on Alpha-VMS and PA-HPUX.
   ...
   begin
      ...
      --  sequence of statements. We would then always get this new buf in
      --  Jumpbuf_Ptr instead of the one for the exception we are handling,
      --  which would completely break the whole design of this procedure.
