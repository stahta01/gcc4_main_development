...
package System.Soft_Links is
   ...
   --
   --  The null value of this wrapper shall correspond to the null value of
   --  the current actual decorator. This is ensured first by the null initial
   --  value of the corresponding variables, and then by Set_Trace_Decorator in
   --  g-exctra.adb.
