...
--                                                                          --
--                                 S p e c                                  --
--                (VxWorks 6 Ravenscar Cert RTP Version E500)               --
--                                                                          --
...
--  Level A certifiable Ravenscar VxWorks 6 RTP PPC version
...
private
   ...
   pragma Linker_Options ("-vxcert");
   --  Experimental, tentative to get the proper -L added via gcc specs
