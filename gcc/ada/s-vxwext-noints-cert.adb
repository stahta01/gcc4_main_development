...
package body System.VxWorks.Ext is
   ...
   pragma Weak_External (sigwaitinfo);
   --  Dummy version for 653 cert POS. sigwaitinfo is is provided on debug POS.
   --  Make this dummy symbol weak so that it can be overriden by the real one
   --  in such a case.
